...
if [ $qq -gt 0 ]; then
	...
	echo "docker service create --name tmp1-svc2 --replicas 2 --publish 8082:8080 --env WEB=$2 --env CUSTOM_STRING=$1 --env BUILD_TAG=$2 $1"
	docker service create --name tmp1-svc2 --replicas 2 --publish 8082:8080 --env WEB=$2 --env CUSTOM_STRING=$1 --env BUILD_TAG=$2 $1 
fi
